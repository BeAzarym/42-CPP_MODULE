...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/10 16:43:41 by cchabeau          #+#    #+#             */
/*   Updated: 2024/03/10 17:23:27 by cchabeau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	const Animal *x[8] = {new Dog(), new Dog(), new Dog(), new Dog(), new Cat(), new Cat(), new Cat(), new Cat()};
